...
{
    Task<ScanCacheEntry?> TryGetValidAsync(string path, long size, DateTime lastWriteUtc, CancellationToken cancellationToken);
    Task StoreAsync(ScanCacheEntry entry, CancellationToken cancellationToken);
...
public interface IScanService
{
    ...
    Task<ScanResult> ScanQuickAsync(IProgress<ScanProgress>? progress, CancellationToken cancellationToken);
    Task<ScanResult> ScanFullAsync(IProgress<ScanProgress>? progress, CancellationToken cancellationToken);
    Task<ScanResult> ScanCustomAsync(string path, IProgress<ScanProgress>? progress, CancellationToken cancellationToken);
    Task CancelAsync();
